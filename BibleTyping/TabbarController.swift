...
final class TabbarController: UITabBarController {
    override func viewDidLoad() {
        ...
        PuzzleController.tabBarItem = UITabBarItem(title: "퍼즐맞추기", image: UIImage(systemName: "puzzlepiece.extension"), selectedImage: UIImage(systemName: "puzzlepiece.extension.fill"))
